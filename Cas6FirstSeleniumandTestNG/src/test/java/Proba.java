...
//        driver.findElement(By.xpath("//*[text()='//*[text()='\t\t\t\t\t\t\t18. Home-Arrivals-Add to Basket-Items-Check-out-Payment Gateway-Place order\t\t\t\t\t\t']']")).click();
        Thread.sleep(1000);
        driver.findElement(By.xpath("//*[@id='accordion-222-sub_row_1-0-1-0-0']/ul//li[18]/div/a/i")).click();
        Thread.sleep(1000);
        String textelement=driver.findElement(By.xpath("//*[contains(@class,'title') and text()='Home Page']/../ul/li[18]/div[2]/p/br[2]")).getText();
